...
1. Generate 64 bytes using ChaCha20 where input data is the initial secret key and the parameters described above. The input data of the next ChaCha20 operation will be an output of the previous one.
